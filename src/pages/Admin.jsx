...
//    const response = await request.json();
  ...
  onOrderChange = (items) => {
    this.setState(state => ({...state, items}), () => console.log('updated'));
  };
